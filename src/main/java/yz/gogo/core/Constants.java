...
public final class Constants {
     ...
     * URL前缀
     */
    private static final String URL_REFIX = System.getProperty("google.search.host", "https://www.google.com");
     ...
     * 谷歌搜索URL模板
     */
    public static final String GOOGLE_SEARCH_URL_TEMPLATE = URL_REFIX +
            "/search?safe=strict&q=%s&start=%d";
    /**
     * 谷歌搜索补全URL模板
     */
    public static final String GOOGLE_SEARCH_COMPLETE_URL_TEMPLATE = URL_REFIX +
